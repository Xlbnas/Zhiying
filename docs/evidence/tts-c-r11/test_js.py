...
def js21(h):
    ...
    ok, msg = h.expect_abort_any(
        ...
        ["owner requires execution command", "CHECK constraint failed"])
    assert ok, msg
...
def js23(h):
    ...
    ok, msg = h.expect_abort(
        ...
        VALUES ('T2','req-T2','J1','C1','lease_renewal','running','running','running','running',
    ...
    ok, msg = h.expect_abort(
        ...
        (id,transition_request_id,job_id,claim_id,command_kind,
         ...
         worker_owner_token,worker_lease_expires_at_epoch_ms,worker_attempt,
         heartbeat_at,activated_at,created_at)
        VALUES ('T3','req-T3','J1','C1','lease_renewal','running','running','running','running',
...
def js24b(h):
    ...
    ok, msg = h.expect_abort(
        ...
        (id,transition_request_id,job_id,claim_id,command_kind,
         ...
         worker_owner_token,worker_lease_expires_at_epoch_ms,worker_attempt,
         claimed_at,heartbeat_at,activated_at,created_at)
        VALUES ('T2','req-T2','J1','C1','execution_takeover','running','running','running','running',
...
def js25(h):
    ...
    ok, msg = h.expect_abort(
        ...
        (id,transition_request_id,job_id,claim_id,command_kind,
         ...
         worker_owner_token,worker_lease_expires_at_epoch_ms,worker_attempt,
         claimed_at,heartbeat_at,activated_at,created_at)
        VALUES ('T3','req-T3','J1','C1','execution_takeover','running','running','running','running',
...
def js26b(h):
    ...
    ok, msg = h.expect_abort(
        ...
        (id,transition_request_id,job_id,claim_id,command_kind,
         ...
         worker_owner_token,worker_attempt,
         error_code,activated_at,created_at)
        VALUES ('T4','req-T4','J1','C1','state_transition','running','failed','running','failed',
                'w1',1,'E1',%s,%s)""" % (q(iso(0)), q(iso(0))),
        "worker fencing mismatch")
    assert ok, msg
...
def js29(h):
    ...
    ok, msg = h.expect_abort(
        ...
        VALUES ('T2','req-T2','J1','C1','prestart_terminal','generation_pending','failed','queued','failed',
    ...
    ok, msg = h.expect_abort(
        ...
        VALUES ('T3','req-T3','J9','C9','prestart_terminal','generation_pending','failed','queued','failed',
                'w1',1,'E1',%s,%s)""" % (q(iso(0)), q(iso(0))),
...
def js30(h):
    ...
    ok, msg = h.expect_abort(
        ...
        VALUES ('T1','req-T1','J1','C1','worker_claim','generation_pending','running','queued','running',
    ...
    ok, msg = h.expect_abort(
        ...
        VALUES ('T3','req-T3','J1','C1','state_transition','running','failed','running','failed',
...
def js35(h):
    ...
    ok, msg = h.expect_abort(
        ...
        (id,transition_request_id,job_id,claim_id,command_kind,
         from_claim_status,to_claim_status,from_job_status,to_job_status,
         worker_owner_token,worker_attempt,error_code,activated_at,created_at)
        VALUES ('T1','req-T1','J1','C1','prestart_terminal','generation_pending','failed','queued','failed',
                'w1',1,'E1',%s,%s)""" % (q(iso(0)), q(iso(0))),
        "CHECK constraint failed")
    assert ok, msg
