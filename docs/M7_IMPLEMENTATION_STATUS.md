...
| 字段 | 值 |
|---|---|
| statusUpdatedAt | 2026-08-03T09:15Z（M7.3B FROZEN；**TTS-A FROZEN**；**TTS-B.R3 review closure in progress**，pending independent Review PASS；TTS-B not frozen；TTS-C not started） |
