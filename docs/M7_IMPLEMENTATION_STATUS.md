...
| 字段 | 值 |
|---|---|
| statusUpdatedAt | 2026-08-04T16:55Z（M7.3B FROZEN；**TTS-A FROZEN**；**TTS-B FROZEN（独立 Review PASS）**；**TTS-C.0 = FROZEN（独立 Review PASS）**；**TTS-C.1A.R2 deployed（pending independent Review PASS；not frozen；production POST disabled）**；TTS-C.1B / 1C / C.2 not started） |
...
| productionRuntimeSHA | `f7965c2df4d0513ce631044134841c59af988354`（TTS-C.1A.R2 部署后容器镜像实际代码 SHA；TTS-C.0 freeze 基线与 CI 证据见 §11.4） |
| productionHostCheckoutSHA | `f7965c2df4d0513ce631044134841c59af988354`（宿主机 checkout；可因 docs/ops commit 高于 runtime） |
| 当前分支 | `m7` |
