...
| 字段 | 值 |
|---|---|
| statusUpdatedAt | 2026-08-03T07:40Z（M7.3B FROZEN；**TTS-A FROZEN**；**TTS-B.R2 review closure in progress（TTS-B not frozen）**；TTS-C not started） |
