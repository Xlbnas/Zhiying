# Extreme Long Video — Semantic State Density Audit V2.2.1
...
| S035 | 5.5s | 1 | 0.4s | 5.1s | 4.0s | no | no | PASS | none |
| S036 | 6.2s | 1 | 0.5s | 5.7s | 4.5s | no | no | PASS | none |
| S037 | 5.5s | 1 | 0.4s | 5.1s | 4.0s | no | no | PASS | none |
| S038 | 8.2s | 2 | 0.6s, 4.5s | 4.0s | 2.5s | no | no | PASS | none |
